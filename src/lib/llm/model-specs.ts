...
export const MODEL_SPECS: ModelSpec[] = [
    // ==================== OpenAI ====================
    { pattern: 'gpt-4o', contextLength: 128000, type: 'chat', capabilities: { vision: true }, icon: 'openai', note: 'GPT-4o series' },
    { pattern: 'gpt-4-turbo', contextLength: 128000, type: 'chat', icon: 'openai', note: 'GPT-4 Turbo' },
    ...
    // O1 系列（推理模型，无法关闭推理）
    { pattern: 'o1-preview', contextLength: 128000, type: 'reasoning', capabilities: { reasoning: true }, forcedReasoning: true, icon: 'openai', note: 'O1 Preview' },
    { pattern: 'o1-mini', contextLength: 128000, type: 'reasoning', capabilities: { reasoning: true }, forcedReasoning: true, icon: 'openai', note: 'O1 Mini' },
    { pattern: 'o1', contextLength: 200000, type: 'reasoning', capabilities: { reasoning: true }, forcedReasoning: true, icon: 'openai', note: 'O1' },

    // ==================== Anthropic ====================
    { pattern: 'claude-3-5-sonnet', contextLength: 200000, icon: 'anthropic', note: 'Claude 3.5 Sonnet' },
    ...
    // ==================== Google Gemini ====================
    { pattern: 'gemini-2.0-flash-thinking', contextLength: 1000000, type: 'reasoning', capabilities: { reasoning: true }, icon: 'google', note: 'Gemini 2.0 Flash Thinking' },
    { pattern: 'gemini-2.0', contextLength: 1000000, type: 'chat', capabilities: { vision: true }, icon: 'google', note: 'Gemini 2.0' },
    { pattern: 'gemini-1.5-pro', contextLength: 2000000, type: 'chat', capabilities: { vision: true }, icon: 'google', note: 'Gemini 1.5 Pro' },
    { pattern: 'gemini-1.5', contextLength: 1000000, type: 'chat', icon: 'google', note: 'Gemini 1.5' },
    ...
    // ==================== DeepSeek (深度求索) ====================
    { pattern: 'deepseek-reasoner', contextLength: 64000, type: 'reasoning', capabilities: { reasoning: true }, forcedReasoning: true, icon: 'deepseek', note: 'DeepSeek R1 (Native Reasoning)' },
    { pattern: 'deepseek-r1', contextLength: 64000, type: 'reasoning', capabilities: { reasoning: true }, forcedReasoning: true, icon: 'deepseek', note: 'DeepSeek R1' },
    { pattern: 'deepseek-v3', contextLength: 64000, type: 'chat', icon: 'deepseek', note: 'DeepSeek V3' },
    ...
    // ==================== Moonshot (Kimi) ====================
    { pattern: 'thinking', contextLength: 128000, type: 'reasoning', capabilities: { reasoning: true }, icon: 'kimi' },
