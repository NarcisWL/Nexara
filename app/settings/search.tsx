...
export default function SearchSettingsScreen() {
  ...
  useEffect(() => {
    setHasChanges(
      apiKey !== (googleSearchConfig?.apiKey || '') || cx !== (googleSearchConfig?.cx || ''),
    );
      ...
      >
        ...
        <View className="space-y-6">
          <View>
            ...
            <TouchableOpacity
              onPress={() =>
                Linking.openURL('https://developers.google.com/custom-search/v1/introduction')
              }
            >
          ...
          <View>
            ...
            <TouchableOpacity
              onPress={() =>
                Linking.openURL('https://programmablesearchengine.google.com/controlpanel/create')
              }
            >
              <Typography className="text-xs text-blue-500 mt-2">
        ...
        <TouchableOpacity
          onPress={handleSave}
          disabled={!hasChanges}
          className={`mt-10 py-4 rounded-xl items-center justify-center shadow-sm ${
            hasChanges
        ...
        >
          <Typography
            className={`font-bold text-lg ${hasChanges ? 'text-white' : 'text-gray-400 dark:text-gray-500'}`}
          >
