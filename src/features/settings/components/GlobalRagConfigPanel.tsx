...
export const GlobalRagConfigPanel: React.FC = () => {
    ...
    return (
        <View>
            ...
            <View className="bg-white dark:bg-zinc-900 rounded-3xl p-5 border border-gray-100 dark:border-zinc-800 mb-8">
                    ...
                    <View className="pl-4 border-l-2 border-gray-100 dark:border-zinc-800 mb-6">
                        <View className="mb-4">
                            ...
                            <View className="flex-row justify-between mb-1">
                                ...
                                <Typography className="text-sm font-bold text-indigo-600 dark:text-indigo-400">{globalRagConfig.rerankTopK ?? 30}</Typography>
                        ...
                        <View>
                            ...
                            <View className="flex-row justify-between mb-1">
                                ...
                                <Typography className="text-sm font-bold text-indigo-600 dark:text-indigo-400">{globalRagConfig.rerankFinalK ?? 8}</Typography>
                    ...
                    <View className="pl-4 border-l-2 border-gray-100 dark:border-zinc-800 mb-6">
                            ...
                            <View className="flex-row gap-2">
                                {(['multi-query', 'expansion', 'hyde'] as const).map(strategy => (
                                    <TouchableOpacity
                                        ...
                                        className={`px-3 py-1.5 rounded-lg border ${globalRagConfig.queryRewriteStrategy === strategy
                                    ...
                                    >
                                        <Typography className={`text-xs font-medium ${globalRagConfig.queryRewriteStrategy === strategy
                        ...
                        <View>
                            ...
                            <View className="flex-row justify-between mb-1">
                                ...
                                <Typography className="text-sm font-bold text-indigo-600 dark:text-indigo-400">{globalRagConfig.queryRewriteCount ?? 3}</Typography>
                    ...
                    <View className="pl-4 border-l-2 border-gray-100 dark:border-zinc-800">
                        <View>
                            ...
                            <Typography className="text-xs text-gray-500 dark:text-gray-400 mb-2">
                                {globalRagConfig.hybridAlpha && globalRagConfig.hybridAlpha > 0.5 ? t.rag.alphaVector : t.rag.alphaKeyword}
                                ({globalRagConfig.hybridAlpha?.toFixed(1)})
                            </Typography>
                            <View className="flex-row justify-between mb-1">
