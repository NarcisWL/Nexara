...
export default function AgentSessionsScreen() {
    ...
    const sessions = useMemo(() => getSessionsByAgent(agentId), [agentId, allSessions, getSessionsByAgent]);
            ...
            <FlashList
                ...
                ListEmptyComponent={
                    <View className="flex-1 items-center justify-center pt-20 px-10">
                        ...
                        <Typography className="text-gray-900 dark:text-white font-bold text-center mb-2">{t.agent.noHistory}</Typography>
                        <Typography className="text-gray-400 text-center text-sm leading-5">{t.agent.noHistoryDesc}</Typography>
                    </View>
                }
