                ...
                <View style={styles.topBar}>
                    ...
                    <View style={{ flexDirection: 'row', gap: 8, paddingRight: 12 }}>
                        <TouchableOpacity
                            ...
                            style={[
                                styles.toggleButton,
                                webSearchEnabled && { backgroundColor: isDark ? 'rgba(59, 130, 246, 0.2)' : 'rgba(59, 130, 246, 0.1)' }
                            ]}
                        >
                            <Globe
                                size={14}
                        ...
                        <TouchableOpacity
                            ...
                            style={[
                                styles.toggleButton,
                                (reasoningEnabled || isModelForcedReasoning) && { backgroundColor: isDark ? 'rgba(139, 92, 246, 0.2)' : 'rgba(139, 92, 246, 0.1)' },
                                isModelForcedReasoning && { opacity: 0.6 }
                            ]}
                        >
                            <BrainCircuit
                                size={14}
                                color={(reasoningEnabled || isModelForcedReasoning) ? '#8b5cf6' : (isDark ? '#52525b' : '#a1a1aa')}
                    ...
                    <View style={styles.buttonContainer}>
                        ...
                        <TouchableOpacity
                            ...
                            style={[
                                styles.sendButton,
                                {
                                    backgroundColor: (text.trim() || selectedImages.length > 0 || loading) ? agentColor : '#cbd5e1',
