import { Easing, WithTimingConfig, WithSpringConfig, FadeIn, FadeOut, SlideInUp, SlideInDown, ZoomIn, ZoomOut, LayoutAnimation } from 'react-native-reanimated';
...
export const LayoutAnimations = {
    ...
    // Modals & Dialogs
    ModalEnter: FadeIn.duration(ANIMATION_DURATION.NORMAL).springify().damping(20).stiffness(150).mass(0.9),
    ModalExit: FadeOut.duration(ANIMATION_DURATION.FAST),

    SlideUpEnter: SlideInUp.duration(ANIMATION_DURATION.NORMAL).springify().damping(20).stiffness(150),
