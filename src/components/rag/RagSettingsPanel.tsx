        ...
        <View style={styles.container}>
            <View style={styles.headerRow}>
                ...
                {onReset && !isGlobal && config && (
                    ...
                    >
                        ...
                        <Text style={[styles.resetText, { color: isDark ? '#818cf8' : '#6366f1' }]}>{t.rag.resetToGlobal}</Text>
                    </TouchableOpacity>
                )}
            </View>
            ...
            <View style={styles.fieldContainer}>
                <View style={styles.labelRow}>
                    ...
                    <Text style={[styles.value, { color: subTextColor }]}>{effectiveConfig.contextWindow} 轮</Text>
                </View>
            ...
            <View style={{ marginBottom: 20 }}>
                <Text style={[styles.label, { color: labelColor, marginBottom: 12 }]}>快速配置 (Presets)</Text>
                <View style={{ flexDirection: 'row', gap: 8 }}>
                    <TouchableOpacity
                        ...
                        style={[
                            styles.presetBtn,
                            {
                                ...
                                borderColor: activePreset === 'balanced' ? '#10b981' : (isDark ? '#334155' : '#e2e8f0')
                            }
                        ]}
                    >
                        <View style={{ flexDirection: 'row', alignItems: 'center', marginBottom: 4 }}>
                            <Sparkles size={14} color={activePreset === 'balanced' ? '#10b981' : subTextColor} />
                            <Text style={[styles.presetTitle, { color: activePreset === 'balanced' ? '#10b981' : textColor, marginLeft: 6 }]}>
                    ...
                    <TouchableOpacity
                        ...
                        style={[
                            ...
                            {
                                backgroundColor: isDark ? '#1e293b' : '#f1f5f9',
                                borderColor: activePreset === 'writing' ? '#f59e0b' : (isDark ? '#334155' : '#e2e8f0')
                            }
                        ]}
                    >
                        <View style={{ flexDirection: 'row', alignItems: 'center', marginBottom: 4 }}>
                            <BookOpen size={14} color={activePreset === 'writing' ? '#f59e0b' : subTextColor} />
                            <Text style={[styles.presetTitle, { color: activePreset === 'writing' ? '#f59e0b' : textColor, marginLeft: 6 }]}>
                                {t.rag.presetWriting}
                            </Text>
                        </View>
                    ...
                    >
                        <View style={{ flexDirection: 'row', alignItems: 'center', marginBottom: 4 }}>
                            ...
                            <Text style={[styles.presetTitle, { color: activePreset === 'code' ? '#6366f1' : textColor, marginLeft: 6 }]}>
                                {t.rag.presetCode}
                            </Text>
                        </View>
            ...
            <View style={styles.fieldContainer}>
                <View style={styles.labelRow}>
                    ...
                    <Text style={[styles.value, { color: subTextColor }]}>{effectiveConfig.chunkOverlap} chars</Text>
                </View>
            ...
            <View style={styles.fieldContainer}>
                ...
                <Text style={[styles.description, { color: descColor, marginBottom: 8 }]}>{t.rag.summaryPromptDesc}</Text>
                <TextInput
                    style={[styles.promptInput, { backgroundColor: inputBg, borderColor: inputBorder, color: textColor }]}
                    multiline
                    numberOfLines={4}
