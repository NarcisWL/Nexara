...
export const DocumentPickerModal: React.FC<DocumentPickerModalProps> = ({
    ...
    const [tempSelectedDocIds, setTempSelectedDocIds] = useState<Set<string>>(new Set(selectedDocIds));
    const [tempSelectedFolderIds, setTempSelectedFolderIds] = useState<Set<string>>(new Set(selectedFolderIds));
    ...
    const breadcrumbs = useMemo(() => {
        const crumbs: Array<{ id: string | undefined; name: string }> = [{ id: undefined, name: '全部' }];
                ...
                >
                    ...
                    {currentItems.documents.map(doc => {
                        ...
                        return (
                            ...
                            >
                                <View className={`w-10 h-10 rounded-lg items-center justify-center mr-3 ${isSelected ? 'bg-indigo-100 dark:bg-indigo-900/40' : 'bg-white dark:bg-zinc-800'
                                    }`}>
